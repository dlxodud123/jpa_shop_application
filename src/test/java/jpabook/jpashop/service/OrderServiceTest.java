...
public class OrderServiceTest {
    ...
    public void 상품주문() throws Exception{
        ...
        Item book = createBook("노인과 바다", 10000, 10);
    ...
    public void 상품주문_재고수량초과() throws Exception{
        // given
        Member member = createMember();
        Book book = createBook("노인과 바다", 10000, 10);
        ...
        assertThrows(
                ...
                // when
                () -> orderService.order(member.getId(), book.getId(),
                        orderCount));
    }
    ...
    public void 주문취소() throws Exception{
        // given
        Member member = createMember();
        Book item = createBook("노인과 바다", 10000, 10);
    ...
    private Member createMember() {
        ...
        member.setName("회원1");
        member.setAddress(new Address("서울", "도봉구", "쌍문동"));
        em.persist(member);
        return member;
    }
